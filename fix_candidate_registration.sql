...
-- Run this script in your Supabase SQL Editor to fix the 401/403 errors
...
-- 9. Verify the setup
SELECT 'RLS policies for candidate_sessions have been updated successfully' as status;
